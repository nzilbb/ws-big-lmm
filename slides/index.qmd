...
## Exercise 1 (cont.) {background-color="#191818"}
...
::: {.fragment .fade-in .big .backlight}
- `lm()` not `lmer()`
    - Why no mixed effects?
- `(var_1 + var_2) * var_3` syntax
:::
...
constant the local effects of the predictors. Thus, the results show – for
example – that words that are increasing in utterance finality are also
